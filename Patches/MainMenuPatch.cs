...
namespace TheDoraemon.Modules {
    ...
    public class MainMenuPatch {
        ...
        private static void CheckAndUnpatch()
        {
            ...
            {
                TheDoraemonPlugin.Logger.LogMessage("Hacker Plugin Found.\n TDR Does Not Allow You Using Such Plugins.\nWill Unpatch Soon.");
    ...
    public static class VersionShower_Start
    {
        public static void Postfix(VersionShower __instance)
        {
            __instance.text.text = $"Among Us v{DestroyableSingleton<ReferenceDataManager>.Instance.Refdata.userFacingVersion} - " +
                $"{Helpers.GradientColorText("FFD700", "FF0000", $"The Other Roles GM IA")} <color=#FCCE03FF>v{TheDoraemonPlugin.VersionString + (TheDoraemonPlugin.betaDays > 0 ? "-BETA" : "")}</color>";
        }
    }
    ...
    public static class MainMenuSetUpPatch
    {
        ...
        public static void Postfix(MainMenuManager __instance)
        {
            ...
            modButton.transform.FindChild("FontPlacer").GetChild(0).GetComponent<TextTranslatorTMP>().SetModText("TDR");
            ...
            modScreen.transform.GetChild(0).GetChild(0).GetComponent<TextTranslatorTMP>().SetModText("The Doraemon");
            ...
            SetUpButton(ModTranslation.getString("TDRs"), () => {
                AchievementViewer.Open(__instance);
            });
            ...
            void createAboutScreen()
            {
                ...
                foreach (var contributor in contributors)
                {
                    ...
                    new MetaContextOld.Image(Helpers.loadSpriteFromResources($"TheDoraemon.Resources.Contributors.{contributor.Key}.png", 50f)) { Width = 0.7f },
        ...
        {
            if (sprite == null) sprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.LogoButton.png", 100f);
            if (discordSprite == null) discordSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.DiscordIcon.png", 100f);
        }
    }
