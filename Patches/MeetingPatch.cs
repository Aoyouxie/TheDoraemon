    ...
    class MeetingHudPatch {
            ...
            private static Dictionary<byte, int> CalculateVotes(MeetingHud __instance) 
            {
                ...
                if (Swapper.swapper != null && !Swapper.swapper.Data.IsDead)
                {
                    ...
                    if (swapped1 != null && swapped2 != null) {
                        TheDoraemonPlugin.Logger.LogMessage("Swapping votes");
        ...
        static void guesserOnClick(int buttonTarget, MeetingHud __instance) {
            ...
            foreach (RoleInfo roleInfo in RoleInfo.allRoleInfos) {
                ...
                if (roleInfo.roleId == RoleId.Deputy && (CustomOptionHolder.deputySpawnRate.getSelection() == 0 || CustomOptionHolder.timespaceManagerSpawnRate.getSelection() == 0)) continue;   
            ...
            {
                if (roleInfo == null) TheDoraemonPlugin.Logger.LogMessage("RoleInfo is null while initializing!");
        ...
        {
            private static Sprite MoriartyIndicator => Helpers.loadSpriteFromResources("TheDoraemon.Resources.MoriartyIndicator.png", 75f);
        ...
        {
            static private Image LightColorSprite = SpriteLoader.FromResource("TheDoraemon.Resources.ColorLight.png", 100f);
            static private Image DarkColorSprite = SpriteLoader.FromResource("TheDoraemon.Resources.ColorDark.png", 100f);
