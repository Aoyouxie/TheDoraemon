            ...
            public static void Postfix(GameStartManager __instance) {
                ...
                foreach (InnerNet.ClientData client in AmongUsClient.Instance.allClients.ToArray()) {
                    if (client.Character == null) continue;
                        ...
                        int diff = TheDoraemonPlugin.Version.CompareTo(PV.version);
                        if (diff > 0) {
                ...
                // Client update with handshake infos
                    ...
                    if (!playerVersions.ContainsKey(AmongUsClient.Instance.HostId) || TheDoraemonPlugin.Version.CompareTo(playerVersions[AmongUsClient.Instance.HostId].version) != 0
