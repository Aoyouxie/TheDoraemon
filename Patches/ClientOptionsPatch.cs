...
namespace TheDoraemon.Patches 
{
    ...
    public static class ClientOptionsPatch
    {
        private static SelectionBehaviour[] AllOptions = {
            new SelectionBehaviour("ghostsSeeInfoButton", () => TORMapOptions.ghostsSeeInformation = TheDoraemonPlugin.GhostsSeeInformation.Value = !TheDoraemonPlugin.GhostsSeeInformation.Value, TheDoraemonPlugin.GhostsSeeInformation.Value),
            new SelectionBehaviour("ghostsSeeVotesButton", () => TORMapOptions.ghostsSeeVotes = TheDoraemonPlugin.GhostsSeeVotes.Value = !TheDoraemonPlugin.GhostsSeeVotes.Value, TheDoraemonPlugin.GhostsSeeVotes.Value),
            new SelectionBehaviour("ghostsSeeRolesButton", () => TORMapOptions.ghostsSeeRoles = TheDoraemonPlugin.GhostsSeeRoles.Value = !TheDoraemonPlugin.GhostsSeeRoles.Value, TheDoraemonPlugin.GhostsSeeRoles.Value),
            new SelectionBehaviour("ghostsSeeModifiersButton", () => TORMapOptions.ghostsSeeModifier = TheDoraemonPlugin.GhostsSeeModifier.Value = !TheDoraemonPlugin.GhostsSeeModifier.Value, TheDoraemonPlugin.GhostsSeeModifier.Value),
            new SelectionBehaviour("showRoleSummaryButton", () => TORMapOptions.showRoleSummary = TheDoraemonPlugin.ShowRoleSummary.Value = !TheDoraemonPlugin.ShowRoleSummary.Value, TheDoraemonPlugin.ShowRoleSummary.Value),
            new SelectionBehaviour("showLighterDarker", () => TORMapOptions.showLighterDarker = TheDoraemonPlugin.ShowLighterDarker.Value = !TheDoraemonPlugin.ShowLighterDarker.Value, TheDoraemonPlugin.ShowLighterDarker.Value),
            new SelectionBehaviour("toggleCursor", () => TORMapOptions.toggleCursor = TheDoraemonPlugin.ToggleCursor.Value = !TheDoraemonPlugin.ToggleCursor.Value, TheDoraemonPlugin.ToggleCursor.Value),
            new SelectionBehaviour("enableSoundEffects", () =>  {
                TORMapOptions.enableSoundEffects = TheDoraemonPlugin.EnableSoundEffects.Value = !TheDoraemonPlugin.EnableSoundEffects.Value;
                if (!TORMapOptions.enableSoundEffects) SoundEffectsManager.stopAll();
                 return TORMapOptions.enableSoundEffects;
                }, TheDoraemonPlugin.EnableSoundEffects.Value),
            new("showChatNotification", () => TORMapOptions.ShowChatNotifications = TheDoraemonPlugin.ShowChatNotifications.Value = !TheDoraemonPlugin.ShowChatNotifications.Value, TheDoraemonPlugin.ShowChatNotifications.Value),
            new("showVentsOnMap", () => TORMapOptions.ShowVentsOnMap = TheDoraemonPlugin.ShowVentsOnMap.Value = !TheDoraemonPlugin.ShowVentsOnMap.Value, TheDoraemonPlugin.ShowVentsOnMap.Value),
            new("showExtraInfo", () => TORMapOptions.showExtraInfo = TheDoraemonPlugin.ShowExtraInfo.Value = !TheDoraemonPlugin.ShowExtraInfo.Value, TheDoraemonPlugin.ShowExtraInfo.Value)
        };
