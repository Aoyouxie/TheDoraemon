...
namespace TheDoraemon.Patches
{
    ...
    public class SpawnInMinigamePatch
    {
        ...
        public static void resetSpawnCandidates()
        {
            ...
            {
                SpawnCandidates.Add(new SpawnCandidate(StringNames.VaultRoom, new Vector2(-8.8f, 8.6f), "TheDoraemon.Resources.Locations.VaultButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.MeetingRoom, new Vector2(11.0f, 14.7f), "TheDoraemon.Resources.Locations.MeetingButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Cockpit, new Vector2(-22.0f, -1.2f), "TheDoraemon.Resources.Locations.CockpitButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Electrical, new Vector2(16.4f, -8.5f), "TheDoraemon.Resources.Locations.ElectricalButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Lounge, new Vector2(30.9f, 7.5f), "TheDoraemon.Resources.Locations.LoungeButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Medical, new Vector2(25.5f, -5.0f), "TheDoraemon.Resources.Locations.MedicalButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Security, new Vector2(10.3f, -16.2f), "TheDoraemon.Resources.Locations.SecurityButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.ViewingDeck, new Vector2(-14.1f, -16.2f), "TheDoraemon.Resources.Locations.ViewingButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Armory, new Vector2(-10.7f, -6.3f), "TheDoraemon.Resources.Locations.ArmoryButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Comms, new Vector2(-11.8f, 3.2f), "TheDoraemon.Resources.Locations.CommunicationsButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.Showers, new Vector2(20.8f, 2.8f), "TheDoraemon.Resources.Locations.ShowersButton.png", "rollover_brig"));
                SpawnCandidates.Add(new SpawnCandidate(StringNames.GapRoom, new Vector2(13.8f, 6.4f), "TheDoraemon.Resources.Locations.GapButton.png", "rollover_brig"));
