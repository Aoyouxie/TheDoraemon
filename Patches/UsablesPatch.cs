...
namespace TheDoraemon.Patches {
    ...
    public static class VentUsePatch {
        public static bool Prefix(Vent __instance) {
            ...
            bool canMoveInVents = PlayerControl.LocalPlayer != Jester.jester && !Madmate.madmate.Contains(PlayerControl.LocalPlayer) && PlayerControl.LocalPlayer != CreatedMadmate.createdMadmate; //&& !Trapper.playersOnMap.Contains(PlayerControl.LocalPlayer)
    ...
    public static class MapBehaviourPatch2
    {
        ...
        static Sprite GetKataomoiMarkSprite()
        {
            ...
            kataomoiMarkSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.KataomoiMark.png", 115f);
    ...
    class SurveillanceMinigamePatch {
        ...
        private static Sprite overlaySprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.NightVisionOverlay.png", 350f);
