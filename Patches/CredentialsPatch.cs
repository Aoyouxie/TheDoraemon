...
namespace TheDoraemon.Patches {
    ...
    public static class CredentialsPatch {
        public static string fullCredentialsVersion = $"<size=130%>{Helpers.GradientColorText("FFD700", "FF0000", $"TheDoraemon")}</size>" + $" v{TheDoraemonPlugin.Version.ToString() + (TheDoraemonPlugin.betaDays > 0 ? "-BETA" : "")}";
        /*  public static string fullCredentialsVersion = 
  $@"<size=130%><color=#ff351f>TheDoraemon GM IA</color></size> v{TheDoraemonPlugin.Version.ToString() + (TheDoraemonPlugin.betaDays>0 ? "-BETA": "")}"; */
    ...
    public static string mainMenuCredentials = "mainMenuCredentials";
        ...
        internal static class PingTrackerPatch
        {
            static void Postfix(PingTracker __instance){
                ...
                if (AmongUsClient.Instance.GameState == InnerNet.InnerNetClient.GameStates.Started) {
                    ...
                    __instance.text.text = $"<size=130%>{Helpers.GradientColorText("FFD700", "FF0000", $"TheDoraemon GM IA")}</size>" + $" v{TheDoraemonPlugin.Version.ToString() + (TheDoraemonPlugin.betaDays > 0 ? "-BETA" : "")}\n{gameModeText}" + __instance.text.text;
        ...
        public static class LogoPatch
        {
            ...
            static void Postfix(PingTracker __instance) {
                ...
                loadSprites();
                renderer.sprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.Banner.png", 900f);
            ...
            public static void loadSprites() {
                if (bannerSprite == null) bannerSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.Banner.png", 300f);
                if (banner2Sprite == null) banner2Sprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.Banner2.png", 300f);
                if (horseBannerSprite == null) horseBannerSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.bannerTheHorseRoles.png", 300f);
            }
