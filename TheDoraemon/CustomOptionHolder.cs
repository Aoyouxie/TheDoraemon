...
namespace TheDoraemon
{
    public class CustomOptionHolder
    {
        ...
        public static void Load()
        {
            ...
            //eraserSpawnRate = CustomOption.Create(230, Types.Impostor, cs(Jackal.color, "jackal"), rates, null, true);
           // eraserCooldown = CustomOption.Create(231, Types.Impostor, "eraserCooldown", 30f, 10f, 120f, 5f, eraserSpawnRate, false, "unitSeconds");
            eraserCooldownIncrease = CustomOption.Create(233, Types.Impostor, "eraserCooldownIncrease", 10f, 0f, 120f, 2.5f, jackalSpawnRate, format: "unitSeconds");
            eraserCanEraseAnyone = CustomOption.Create(232, Types.Impostor, "eraserCanEraseAnyone", false, jackalSpawnRate);
            ...
            #endregion
            timespaceManagerSpawnRate = CustomOption.Create(100, Types.Crewmate, cs(TimespaceManager.color, "timespaceManager"), rates, null, true);
            timespaceManagerCooldown = CustomOption.Create(101, Types.Crewmate, "sheriffCooldown", 30f, 10f, 60f, 2.5f, timespaceManagerSpawnRate, false, "unitSeconds");
            timespaceManagerCanKillNeutrals = CustomOption.Create(102, Types.Crewmate, "sheriffCanKillNeutrals", false, timespaceManagerSpawnRate);
            #region
            deputySpawnRate = CustomOption.Create(103, Types.Crewmate, "sheriffDeputy", rates, timespaceManagerSpawnRate);
