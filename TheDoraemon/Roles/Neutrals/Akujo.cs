...
namespace TheDoraemon.Roles.Neutrals
{
    public static class Akujo
    {
        ...
        public static Sprite getHonmeiSprite()
        {
            ...
            honmeiSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.AkujoHonmeiButton.png", 115f);
            return honmeiSprite;
        }
        ...
        public static Sprite getKeepSprite()
        {
            ...
            keepSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.AkujoKeepButton.png", 115f);
            return keepSprite;
        }
