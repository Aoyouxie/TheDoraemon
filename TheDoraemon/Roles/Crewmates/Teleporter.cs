...
namespace TheDoraemon.Roles.Crewmates
{
    public static class Teleporter
    {
        ...
        public static Sprite getButtonSprite()
        {
            ...
            teleportButtonSprite = Helpers.loadSpriteFromResources("namespace TheDoraemon.Resources.TeleporterButton.png", 115f);
        ...
        public class PlayerMenu
        {
            ...
            public IEnumerator Open(float delay, bool includeDead = false)
            {
                ...
                TheDoraemonPlugin.Logger.LogMessage($"Targets {Targets.Count}");
                if (Menu == null)
                {
                    if (Camera.main == null)
                        yield break;
