...
namespace TheDoraemon
{
    public class RoleInfo {
        ...
        public static RoleInfo timespaceManager = new("timespaceManager", TimespaceManager.color, RoleId.TimespaceManager);
        public static RoleInfo deputy = new("deputy", TimespaceManager.color, RoleId.Deputy);
        ...
        public static List<RoleInfo> getRoleInfoForPlayer(PlayerControl p, bool showModifier = true, bool includeHidden = false) {
            ...
            if (p == TimespaceManager.timespaceManager || p == TimespaceManager.formerSheriff) infos.Add(timespaceManager);
