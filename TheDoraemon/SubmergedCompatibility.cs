...
namespace TheDoraemon
{
    public static class SubmergedCompatibility
    {
        ...
        public static bool TryLoadSubmerged()
        {
            try
            {
                TheDoraemonPlugin.Logger.LogMessage("Trying to load Submerged...");
            ...
            {
                TheDoraemonPlugin.Logger.LogError(e);
            }
            return false;
        }
        ...
        public static void RepairOxygen()
        {
            ...
            {
                TheDoraemonPlugin.Logger.LogMessage("null reference in engineer oxygen fix");
            }
