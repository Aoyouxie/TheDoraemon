    ...
    public class Props
    {
        ...
        public class AccelTrap
        {
            ...
            public static Sprite getAccelSprite()
            {
                ...
                accelTrapSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.AccelerateButton.png", 300);
        ...
        public class DecelTrap
        {
            ...
            public static Sprite getDecelSprite()
            {
                ...
                decelTrapSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.DecelerateButton.png", 300);
