...
namespace TheDoraemon.Objects
{
    public class Antique
    {
        ...
        private static Sprite getNormalSprite()
        {
            ...
            normalSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.ArchaeologistAntique.png", 350f);
            return normalSprite;
        }
        ...
        public static Sprite getBrokenSprite()
        {
            ...
            brokenSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.ArchaeologistAntiqueBroken.png", 350f);
            return brokenSprite;
        }
