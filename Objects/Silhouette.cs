...
namespace TheDoraemon.Objects
{
    public class Silhouette
    {
        ...
        public static Sprite getSilhouetteSprite()
        {
            ...
            SilhouetteSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.Silhouette.png", 225f);
        ...
        public Silhouette(Vector3 p, float duration = 1f, bool visibleForEveryOne = true)
        {
            if (duration <= 0f)
            {
                TheDoraemonPlugin.Logger.LogMessage("silhouette: permanent!");
                permanent = true;
            }
        ...
        public static void UpdateAll()
        {
            foreach (Silhouette current in new List<Silhouette>(silhouettes))
            {
                ...
                {
                    TheDoraemonPlugin.Logger.LogMessage($"update: permanent: {current.permanent}, time: {current.timeRemaining}");
