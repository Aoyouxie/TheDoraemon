...
namespace TheDoraemon.Objects
{
    public class Trap
    {
        ...
        {
            if (trapSprite == null)
                trapSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.Trap.png", 300f);
            if (trapActiveSprite == null)
                trapActiveSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.TrapActive.png", 300f);
        ...
        public static void activateTrap(byte trapId, PlayerControl trapper, PlayerControl target)
        {
            ...
            FastDestroyableSingleton<HudManager>.Instance.StartCoroutine(Effects.Lerp(Trapper.killTimer, new Action<float>((p) =>
            {
                ...
                {
                    TheDoraemonPlugin.Logger.LogError("An error occured during the countdown");
                    TheDoraemonPlugin.Logger.LogError(e.Message);
                }
            })));
        }
...
/*namespace TheDoraemon.Objects {
    class Trap {
        ...
        public static Sprite getTrapSprite() {
            ...
            trapSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.Trapper_Trap_Ingame.png", 300f);
            return trapSprite;
        }
