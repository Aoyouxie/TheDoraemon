...
namespace TheDoraemon.Patches
{
    ...
    {
        static private SpriteLoader customMeetingSideSprite = SpriteLoader.FromResource("TheDoraemon.Resources.ladder_bg.png", 100f);
        static private SpriteLoader customMeetingLadderSprite = SpriteLoader.FromResource("TheDoraemon.Resources.ladder.png", 100f);
        ...
        public static void optimizeMap(int mapId)
        {
            ...
            if (mapId == 4)
            {
                ...
                renderer.sprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.AirshipFence.png", 100f);
