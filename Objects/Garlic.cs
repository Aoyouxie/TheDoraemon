...
namespace TheDoraemon.Objects {
    class Garlic {
        ...
        public static Sprite getGarlicSprite() {
            ...
            garlicSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.Garlic.png", 300f);
            return garlicSprite;
        }
        ...
        public static Sprite getBackgroundSprite() {
            ...
            backgroundSprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.GarlicBackground.png", 60f);
