...
namespace TheDoraemon {
    public class CustomOption {
        ...
        public CustomOption(int id, CustomOptionType type, string name,  System.Object[] selections, System.Object defaultValue, CustomOption parent, bool isHeader, string format, Action onChange = null, string heading = "", bool invertedParent = false) {
            ...
            selection = 0;
            if (id != 0) {
                entry = TheDoraemonPlugin.Instance.Config.Bind($"Preset{preset}", id.ToString(), defaultSelection);
        ...
        public static void switchPreset(int newPreset) {
            ...
            vanillaSettings = TheDoraemonPlugin.Instance.Config.Bind($"Preset{preset}", "GameOptions", "");
            loadVanillaOptions();
            foreach (CustomOption option in CustomOption.options) {
                if (option.id == 0) continue;

                option.entry = TheDoraemonPlugin.Instance.Config.Bind($"Preset{preset}", option.id.ToString(), option.defaultSelection);
        ...
        public static bool loadVanillaOptions() {
            ...
            {
                TheDoraemonPlugin.Logger.LogMessage("tried to paste old settings, not doing this!");
                return false;
            }
        ...
        public static int deserializeOptions(byte[] inputValues) {
            ...
            while (reader.BaseStream.Position < inputValues.Length) {
                try {
                    ...
                    TheDoraemonPlugin.Logger.LogWarning($"id:{lastId}:{e}: while deserializing - tried to paste invalid settings!");
                    errors++;
                }
            }
        ...
        public static void copyToClipboard() {
            GUIUtility.systemCopyBuffer = $"{TheDoraemonPlugin.VersionString}!{Convert.ToBase64String(serializeOptions())}!{vanillaSettings.Value}";
        }
        ...
        public static int pasteFromClipboard() {
            ...
            try {
                ...
                ShareOptionSelections();
                if (TheDoraemonPlugin.Version > versionInfo && versionInfo < Version.Parse("1.2.7"))
                {
                ...
                TheDoraemonPlugin.Logger.LogWarning($"{e}: tried to paste invalid settings!\n{allSettings}");
    ...
    class GameOptionsMenuStartPatch
    {
        ...
        public static void Postfix(GameSettingMenu __instance)
        {
            ...
            bgrenderer.sprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.CopyPasteBG.png", 175f);
            ...
            copyButtonRenderer.sprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.Copy.png", 100f);
            copyButton.transform.GetChild(1).transform.localPosition = Vector3.zero;
            copyButtonActiveRenderer.sprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.CopyActive.png", 100f);
            ...
            pasteButtonRenderer.sprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.Paste.png", 100f);
            pasteButtonActiveRenderer.sprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.PasteActive.png", 100f);
    ...
    class GameOptionsDataPatch
    {
        ...
        public static string buildAllOptions(string vanillaSettings = "", bool hideExtras = false) {
            ...
            int counter = TheDoraemonPlugin.optionsPage;
            ...
            if (TORMapOptions.gameMode == CustomGamemodes.HideNSeek) {
                if (TheDoraemonPlugin.optionsPage > 1) TheDoraemonPlugin.optionsPage = 0;
                maxPage = 2;
                switch (counter) {
                    case 0:
    ...
    public static class GameOptionsNextPagePatch
    {
        ...
        {
            int page = TheDoraemonPlugin.optionsPage;
            if (Input.GetKeyDown(KeyCode.Tab)) {
                TheDoraemonPlugin.optionsPage = (TheDoraemonPlugin.optionsPage + 1) % 7;
            }
            if (Input.GetKeyDown(KeyCode.F2) && LobbyBehaviour.Instance)
                HudManagerUpdate.ToggleSummary(HudManager.Instance);
            if (Input.GetKeyDown(KeyCode.Alpha1) || Input.GetKeyDown(KeyCode.Keypad1)) {
                TheDoraemonPlugin.optionsPage = 0;
            }
            if (Input.GetKeyDown(KeyCode.Alpha2) || Input.GetKeyDown(KeyCode.Keypad2)) {
                TheDoraemonPlugin.optionsPage = 1;
            }
            if (Input.GetKeyDown(KeyCode.Alpha3) || Input.GetKeyDown(KeyCode.Keypad3)) {
                TheDoraemonPlugin.optionsPage = 2;
            }
            if (Input.GetKeyDown(KeyCode.Alpha4) || Input.GetKeyDown(KeyCode.Keypad4)) {
                TheDoraemonPlugin.optionsPage = 3;
            }
            if (Input.GetKeyDown(KeyCode.Alpha5) || Input.GetKeyDown(KeyCode.Keypad5)) {
                TheDoraemonPlugin.optionsPage = 4;
            }
            if (Input.GetKeyDown(KeyCode.Alpha6) || Input.GetKeyDown(KeyCode.Keypad6)) {
                TheDoraemonPlugin.optionsPage = 5;
            }
            if (Input.GetKeyDown(KeyCode.Alpha7) || Input.GetKeyDown(KeyCode.Keypad7)) {
                TheDoraemonPlugin.optionsPage = 6;
            }
    ...
    public class HudManagerUpdate {
        ...
        public static void Postfix(HudManager __instance) {
            ...
            if (!toggleSettingsButton || !toggleSettingsButtonObject) {
                ...
                renderer.sprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.Settings_Button.png", 100f);
                rendererActive.sprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.Settings_ButtonActive.png", 100);
            ...
            if (!toggleZoomButton || !toggleZoomButtonObject)
            {
                ...
                tZrenderer.sprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.Minus_Button.png", 100f);
                tZArenderer.sprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.Minus_ButtonActive.png", 100);
        ...
        public static void Postfix2(HudManager __instance)
        {
            ...
            if (!toggleSummaryButton || !toggleSummaryButtonObject)
            {
                ...
                renderer.sprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.Endscreen.png", 100f);
                rendererActive.sprite = Helpers.loadSpriteFromResources("TheDoraemon.Resources.EndscreenActive.png", 100f);
